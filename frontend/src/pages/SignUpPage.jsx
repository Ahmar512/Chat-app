      ...
      <div className='flex flex-col justify-center items-center p-6 sm:p-12'>
        <div className='w-full max-w-md space-y-8'>
          ...
          <label className="input input-bordered flex items-center gap-2 w-[80%] max-sm:w-[100%]">
            ...
            <input type="text" className="grow" placeholder="Full Name" value={formData.fullName} onChange={(e)=> setFormData({...formData, fullName:e.target.value})}/>
          </label>
          <label className="input input-bordered flex items-center gap-2 w-[80%] max-sm:w-[100%]" >
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            {isError?(<p className='text-lg text-red-500'>{isError}</p>):null}
              ...
              <button type='submit' className='btn btn-primary w-[80%] max-sm:w-[100%]' disabled={isSigningUp}>
                {isSigningUp ? (
                  <>
